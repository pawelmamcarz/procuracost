...
export function calculatorFocusTargetElementId(
  ...
  switch (target.kind) {
    ...
    case "decision-record":
      return CALCULATOR_RESULT_REGION_ID;
  }
}
          ...
          <div className="border-t border-gray-200 pt-6">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="sm:text-right">
                <button
                  aria-describedby={
                    validation.canSubmit ? undefined : "process-map-status"
                  }
...
export default function CalculatorWorkspace({ lang }: CalculatorWorkspaceProps) {
  ...
  const updateState = (nextState: CalculatorWorkspaceState) => {
    if (nextState.urlOrigin !== "legacy") setMigrationResult(null);
    setState(nextState);
  };
        ...
        migrationResult
          ? {
              ...
              onConfirm: (confirmed) => {
                ...
                if (confirmed) setMigrationResult(null);
              },
            }
          : undefined
      }
