...
export const metadata = {
  title: "Model 2.0 Methodology | ProcuraCost",
    ...
    <div className="mx-auto max-w-3xl space-y-8 px-6 py-10">
      ...
      <section>
        ...
        <ol className="mt-2 list-decimal space-y-2 pl-5 text-sm text-gray-600">
          ...
          <li>coordination plus equal technology cost;</li>
          <li>delay valued with user-supplied cost of inaction;</li>
          <li>selection risk driven by competition effectiveness;</li>
          <li>renegotiation driven by contract, not workflow, rigidity;</li>
          <li>a scenario TCO pool and path-specific capture rate;</li>
      ...
      <section>
        ...
        <p className="mt-2 text-sm text-gray-600">
          An adaptive public path always remains a lawful PZP design. The optimizer applies the
          PLN 170,000 threshold effective from 1 January 2026 and the relevant EU threshold by
          procurement object and authority level.
        </p>
      </section>
