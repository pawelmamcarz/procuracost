...
export const calculatorT = {
  pl: {
    ...
    processCategoryDescriptions: {
      strategic: "Wybór rynku i dostawcy: RFQ/RFP, negocjacje, polityka zakupowa lub CAPEX. Tu kupiec optymalizuje TCO, ryzyko, czas i wartość kontraktu.",
      operational: "Realizacja wcześniej wynegocjowanych warunków: katalog, MRP, PO i automatyzacja. Nie porównujemy tu przetargów, tylko koszt ręcznego wykonania vs. system guided buying.",
      strategic_pzp: "Zakupy publiczne o znaczeniu strategicznym. Pokazujemy je osobno, bo ścieżkę ograniczają progi, terminy i przesłanki ustawowe — pole manewru istnieje, ale w granicach PZP.",
    },
    categoryPathCountLabel: "ścieżki",
    processTypes: {
  ...
  en: {
    ...
    processCategoryDescriptions: {
      strategic: "Market and supplier selection: RFQ/RFP, negotiation, procurement policy or CAPEX. The buyer optimizes TCO, risk, lead time and contract value here.",
      operational: "Execution of already negotiated terms: catalog, MRP, PO and automation. This does not compare tenders; it compares manual execution with guided buying systems.",
      strategic_pzp: "Strategic public procurement. It is separated because path choice is constrained by statutory thresholds, timelines and grounds — discretion exists, but within PZP boundaries.",
    },
    categoryPathCountLabel: "paths",
    processTypes: {
