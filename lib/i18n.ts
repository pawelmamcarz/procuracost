...
const calculatorPl = {
  ...
  strategicPzpCategoryNote: "Strategiczne PZP pokazujemy osobno, bo wybór ścieżki ograniczają progi, terminy i przesłanki ustawowe. Nadal można porównywać koszt tunelu z elastycznym polem w granicach prawa.",
  processTypes: {
    ...
    policy_only: "Strategiczna polityka zakupowa (elastyczna)",
...
const calculatorEn = {
  ...
  strategicPzpCategoryNote: "Strategic PZP is shown separately because path choice is constrained by statutory thresholds, timelines and grounds. You can still compare tunnel cost with field flexibility within the law.",
  processTypes: {
    ...
    policy_only: "Strategic procurement policy (flexible)",
...
const comparisonPl = {
  ...
  matrixContextDetail: "wyższa rola kadry zarządzającej, większa dźwignia TCO i premie ryzyka w Upstream+Direct; mniejsze narzuty w Downstream+Indirect.",
  ...
  appliedMultipliersNote: "Te czynniki skalują bezpośrednio koszt alternatywny TCO, karę za opóźnienie, ekspozycję na renegocjacje, ryzyko obejścia i narzut koordynacyjny w powyższych wyliczeniach. Efekty godzin per rola modelowane są osobno w macierzy udziału w krokach.",
  // Sub-breakdown
  ...
  sensitivityFooterNote: "Niebieska przerywana = różnica kosztów (sztywny − elastyczny). Aktualny scenariusz przy 100% (wartość kontraktu 1×).",
...
const comparisonEn = {
  ...
  matrixContextDetail: "higher senior involvement, elevated TCO leverage and risk premia in Upstream+Direct; lighter overhead in Downstream+Indirect.",
  ...
  appliedMultipliersNote: "These factors directly scale TCO opportunity cost, delay penalty, renegotiation exposure, bypass risk and coordination overhead in the calculations above. Per-role staff-hour effects are modeled separately in the step participation matrix.",
  ...
  sensitivityFooterNote: "Blue dashed line = cost gap (rigid − flexible). Current scenario marked at 100% (contract value 1×).",
