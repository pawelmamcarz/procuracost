# ProcuraCost: research and service plan, September 2026 to January 2027

**Current research baseline:** native model 2.3.0

**Planning horizon:** September 2026 to January 2027
**Purpose:** Assemble the doctoral file for native model 2.3.0. Keep the
comparison code and records open to audit, and give supervisors a bounded
proposition.
...
The work should name a mechanism that can be observed, not a preferred label.
...
without treating them as one shared finding.
...
- [ ] one practitioner article that uses the distinction in procurement
...
**Objective:** keep the public comparison usable without mixing it with the
empirical claim.
...
## Decision at the end of the horizon

At the end of this horizon, judge the project by evidence, not by the number
of files produced:
