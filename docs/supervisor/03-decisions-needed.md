...
Czy głównym wkładem ma być teoria governance, model kosztowy czy projekt
empiryczny? Obecnie cykl łączy wszystkie trzy, ale każdy artykuł wymaga własnego
jednoznacznego wkładu.
...
Jakie minimum dostępu jest realistyczne: logi procesu, czas pracy, klauzule,
aneksy, wynik dostawy, audyt? Czy promotor może wesprzeć rekrutację organizacji,
koderów i konsultację statystyczną?
