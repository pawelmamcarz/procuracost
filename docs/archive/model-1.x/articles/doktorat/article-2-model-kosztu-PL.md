...
> **WERSJA HISTORYCZNA — NIE DO ZŁOŻENIA ANI CYTOWANIA.** Obliczenia i bibliografia
> opisują model 1.x. Nowy kontrakt ilościowy znajduje się w
> `00-shared-foundation.md` oraz `docs/MODEL_PARAMETERS.md`.
