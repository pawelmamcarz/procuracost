...
export const EPISODES: Episode[] = [
  ...
  },
  {
    ...
    thesis:
      "Uznaniowość podnosi znormalizowaną cenę o ok. 6 pp (Szucs 2024) — konkurencja tę premię ogranicza, ale wynik całkowity zależy również od opóźnienia, kontraktu i TCO.",
    recommendation:
