...
- Szucs (2024): discretion raises price by about 6 percentage points and selects
  28% less productive contractors in the corrected structural estimates. Use
  only for competition/selection, with Hungarian threshold-design caveats.
- Beuve, Moszoro and Spiller (2023): a one-SD increase in contractual rigidity
  raises renegotiation probability by 7.7–10.5 percentage points in French
  car-park contracts, estimated with 2SLS/IV. Do not export 22% as a universal base.
- TCO (0–15%) and bypass (1–30%) are broad scenario assumptions. Theory supports
...
Beuve, J., Moszoro, M., & Spiller, P. T. (2023). Contractual rigidity and
political contestability: Revisiting public contract renegotiations. *Journal of
